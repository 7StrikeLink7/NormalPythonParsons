---
layout: default
title: Nested If statements - divisible by two?
---

![image](https://user-images.githubusercontent.com/68385109/232050194-bdb90cff-90fe-4371-90f0-7727e60fa8ba.png)
...
(function(){
  var initial = "num1 = int(input(&quot;Enter a number: &quot;))\n" +
    ...
    "  else: # This should be indented\n" +
    "    print(&quot;but not divisible by 3.&quot;)\n" +
    "else: #for the first if, so this is not indented.\n" +
    "  print(&quot;Did you know it is not divisble by 2&quot;)";
